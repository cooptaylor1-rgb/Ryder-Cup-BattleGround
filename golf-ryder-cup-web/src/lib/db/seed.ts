...
const DEMO_PLAYERS: Omit<Player, 'id' | 'createdAt' | 'updatedAt'>[] = [
    // Team USA
    { name: 'John Smith', handicapIndex: 8.2, ghin: '1234567' },
    { name: 'Mike Johnson', handicapIndex: 12.5, ghin: '2345678' },
    { name: 'Dave Williams', handicapIndex: 6.8, ghin: '3456789' },
    { name: 'Chris Brown', handicapIndex: 14.2, ghin: '4567890' },
    { name: 'Tom Davis', handicapIndex: 10.1, ghin: '5678901' },
    { name: 'Steve Wilson', handicapIndex: 7.4, ghin: '6789012' },
    // Team Europe
    { name: 'James Miller', handicapIndex: 9.3, ghin: '7890123' },
    { name: 'Robert Taylor', handicapIndex: 11.7, ghin: '8901234' },
    { name: 'William Anderson', handicapIndex: 5.9, ghin: '9012345' },
    { name: 'Richard Thomas', handicapIndex: 13.8, ghin: '0123456' },
    { name: 'Joseph Jackson', handicapIndex: 8.6, ghin: '1234560' },
    { name: 'Charles White', handicapIndex: 10.9, ghin: '2345601' },
];
    ...
    const sessions: RyderCupSession[] = [
        {
            ...
            sessionType: SessionType.Foursomes,
        ...
        },
        {
            ...
            sessionType: SessionType.Fourball,
            scheduledDate: tomorrow.toISOString(),
            timeSlot: 'PM',
            pointsPerMatch: 1,
            isLocked: false,
        ...
        },
        {
            ...
            tripId,
            name: 'Day 2 - Singles',
            sessionType: SessionType.Singles,
