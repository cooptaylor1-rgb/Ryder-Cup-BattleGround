 ...
 *
 * Multi-step profile creation wizard for new users.
 * Collects essential golf trip information.
 */
                        ...
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <div className="space-y-4">
                                ...
                                <InputField
                                    ...
                                    hint="What your golf buddies call you"
                                />
                    ...
                    {step === 3 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            <div className="text-center mb-8">
                                <div className="flex justify-center mb-4">
                                    <div className="w-16 h-16 rounded-full bg-masters/10 flex items-center justify-center">
                                        <Shirt className="w-8 h-8 text-masters" />
                                    </div>
                                </div>
                                <h2 className="text-heading-md font-semibold text-surface-900">
                                    Trip details
                                ...
                                <p className="text-body-sm text-surface-600 mt-1">
                                    Optional info for trip planning
                                </p>
                            </div>
