 ...
 * Bets Error Boundary
 *
 * Handles errors in bets routes with context-specific messaging.
...
export default function BetsError({ error, reset }: ErrorPageProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-[var(--canvas)]">
      ...
      <h1 className="text-2xl font-semibold mb-3 text-[var(--ink)]">Couldn&apos;t Load Bets</h1>

      <p className="text-center max-w-md mb-8 text-[var(--ink-secondary)]">
        There was a problem loading the side bets. Your bets are safe—please try again.
      </p>
