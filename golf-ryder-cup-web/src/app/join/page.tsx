      ...
      <div style={{ textAlign: 'center' }}>
        <div className="animate-pulse" style={{ fontSize: '3rem' }}>
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" style={{ margin: '0 auto' }}>
            ...
            <path d="M24 14v20M14 24h20" stroke="var(--masters)" strokeWidth="2" strokeLinecap="round" />
          </svg>
        </div>
        <p className="type-body-sm" style={{ marginTop: 'var(--space-4)', color: 'var(--ink-secondary)' }}>
          Joining trip...
        </p>
      </div>
    </div>
