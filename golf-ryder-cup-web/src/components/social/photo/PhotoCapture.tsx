...
function CameraView({ onCapture, onClose }: CameraViewProps) {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- Intentional: stream cleanup handled in return, startCamera re-runs on facingMode change
  }, [facingMode]);
...
export function PhotoCapture({
  ...
  return (
    <>
      ...
      {/* Camera View */}
      <AnimatePresence>
        {showCamera && <CameraView onCapture={handleCameraCapture} onClose={handleCloseCamera} />}
      </AnimatePresence>
