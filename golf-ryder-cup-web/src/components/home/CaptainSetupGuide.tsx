...
import { ChevronDown, ChevronUp, Share2, Shield } from 'lucide-react';
            ...
            <div className="mt-[var(--space-4)]">
                <div className="card-captain">
                    ...
                    {expanded ? (
                        ...
                        <Link
                            href={nextStep.href}
                            className="mt-[var(--space-1)] inline-flex items-center gap-[var(--space-2)] text-sm font-medium text-[var(--masters)] no-underline press-scale"
                        >
                            Continue →
                        </Link>
                    ) : null}
