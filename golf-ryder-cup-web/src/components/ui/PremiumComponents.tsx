            ...
            <div className="relative p-5">
                <div className="flex items-start gap-4">
                    ...
                    <div className="shrink-0">
                        <div className="relative w-14 h-14 rounded-xl bg-linear-to-br from-green-500 to-green-600 flex items-center justify-center shadow-lg">
                    ...
                    {/* Arrow */}
                    <ChevronRight className="w-5 h-5 text-ink-tertiary group-hover:text-ink-secondary group-hover:translate-x-1 transition-all shrink-0 mt-4" />
                </div>
    ...
    return (
        ...
        >
            ...
            <div className="flex items-stretch gap-3">
                ...
                {/* Score */}
                <div className="flex flex-col items-center justify-center px-4 min-w-20">
                    <span
                        className={cn(
