...
const illustrationMap: Record<
  IllustrationType,
  ComponentType<{ size?: 'sm' | 'md' | 'lg' | 'xl'; animated?: boolean }>
> = {
...
export function EmptyStatePremium({
  ...
  return (
    <div
      className={cn('empty-state-premium', variant, className)}
    ...
    >
      ...
      {secondaryAction && (
        <button
          ...
          className="empty-state-action-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface)]"
          style={{
            display: 'inline-flex',
            alignItems: 'center',
            minHeight: 44,
...
export function NoCoursesEmpty({ onSearchCourses }: { onSearchCourses: () => void }) {
  return (
    <EmptyStatePremium
      ...
      description="Add courses to your trip. Search the course directory or enter details manually."
      action={{
        label: 'Find Courses',
 ...
 */
export function NoPhotosEmpty({ onUploadPhoto }: { onUploadPhoto?: () => void }) {
  return (
    <EmptyStatePremium
      illustration="celebration"
 ...
 */
export function LoadingEmpty({ message }: { message?: string }) {
  return (
    <EmptyStatePremium
      illustration="swing"
