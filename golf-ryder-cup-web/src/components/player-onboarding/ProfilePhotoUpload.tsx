            ...
            <AnimatePresence>
                {showOptions && !previewPhoto && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed inset-0 z-50 flex items-end justify-center bg-[color:var(--ink)]/50 backdrop-blur-sm"
            ...
            <AnimatePresence>
                {previewPhoto && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed inset-0 z-50 flex items-center justify-center bg-[color:var(--ink)]/80 backdrop-blur-sm p-4"
                    >
                        <motion.div
