        ...
        >
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-masters via-masters/90 to-emerald-600 text-white shadow-xl">
                ...
                <div className="absolute bottom-0 left-0 right-0">
                    <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-8 fill-white dark:fill-surface-900">
            ...
            <motion.div
                ...
                className="bg-white dark:bg-surface-800 rounded-2xl p-4 shadow-sm border border-surface-200 dark:border-surface-700"
            >
            ...
            <motion.div
                ...
                className="bg-white dark:bg-surface-800 rounded-2xl overflow-hidden shadow-sm border border-surface-200 dark:border-surface-700"
            >
                ...
                <div className="grid grid-cols-2">
                    ...
                    <div
                        className={cn(
                            'p-4 text-center border-r border-surface-100 dark:border-surface-700',
