...
- 19:25 — Shipped batch: Settings — Backup & Restore (`/settings/backup`) upgraded to the standard premium wrapper + shared `PageHeader` (Back → `/settings`) for consistent Settings navigation. (commit TBD)
