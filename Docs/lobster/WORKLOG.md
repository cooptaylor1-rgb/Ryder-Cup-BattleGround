...
- QuickScoreFABv2: replaced inline token styles (`var(--surface/masters/ink-*)` + rgba badges/shadows) with token-driven Tailwind classes (`bg-[var(--...)]`, `text-[var(--...)]`, `shadow-[...]`, `bg-white/20`) for consistent premium theming.
